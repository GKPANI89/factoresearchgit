            ...
            <section className="section-padding legal-section">
                <div className="container legal-container">
                    ...
                    <article className="glass-card legal-card legal-download-card">
                        ...
                        <a className="btn-primary legal-download-btn" href="/documents/compliance-audit-status-July-2026.txt" download>
                            Download Compliance Audit Status (TXT) – July 2026
                        </a>
                    </article>
